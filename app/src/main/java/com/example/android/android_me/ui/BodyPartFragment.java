...
public class BodyPartFragment extends Fragment {
    ...
    final static String LIST_INDEX_STATE = "list_index";
    final static String LIST_IMAGES_IDS_STATE = "image_ids";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // Load savedState if there's one
        if(savedInstanceState != null) {
            mImageIds = savedInstanceState.getIntegerArrayList(LIST_IMAGES_IDS_STATE);
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(LIST_IMAGES_IDS_STATE, (ArrayList<Integer>) mImageIds);
